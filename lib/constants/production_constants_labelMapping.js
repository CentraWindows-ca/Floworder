...
import constants, { ALL_SUBORDER_TYPES } from ".";
...
/*
  ...
  fieldCode -> w_Status
*/
export const parseFieldsByfieldCode = (fieldCode, initWithOriginalStructure) => {
  ...
  return _.keys(initWithOriginalStructure)?.map(fac => {
