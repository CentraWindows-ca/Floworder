...
*/
export const parseFieldsByKindField = (fieldOfKind, data) => {
  // fieldCode can be w_Aaaa, data will be like 1_w_Aaaa

}
export const parseFieldsByDbField = (fieldOfDb, data) => {
  // 
}
export const fieldCode = (field) => {
