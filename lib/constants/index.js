...
export const CompletedInvoice = "CompletedInvoice";
...
export const INVOICE_STATUS_AS_GROUP = [
  [
    ...
    INVOICE_STATUS_MAPPING.CompletedInvoice,
  ],
];

export const INVOICE_WORKFLOW = {
  ReadyForInvoice: [Invoiced, OnHoldInvoice],
  Invoiced: [OnHoldInvoice, CompletedInvoice],
...
const DEV_HOLDING_FEATURES = {
  v20250815_screen_number_display: false,
  v20250815_addon: process.env.NEXT_PUBLIC_ENV === "production",
  v20250815_sitelockout_display: process.env.NEXT_PUBLIC_ENV === "production",
  v20251006_createWithLockoutOrService: process.env.NEXT_PUBLIC_ENV === "production",
};
