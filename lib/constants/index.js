...
export const WORKORDER_WORKFLOW = {
  ...
  Scheduled: [InProgress, OnHold, ConfirmedReservation],
...
export const FEATURE_CODES = {
  ...
  "om.prod.wo.scheduleWithoutProduction.window": "om.prod.wo.scheduleWithoutProduction.window",
  "om.prod.wo.scheduleWithoutProduction.door": "om.prod.wo.scheduleWithoutProduction.door",
  "om.prod.wo.scheduleWithProduction.window": "om.prod.wo.scheduleWithProduction.window",
  "om.prod.wo.scheduleWithProduction.door": "om.prod.wo.scheduleWithProduction.door",
