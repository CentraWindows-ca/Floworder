...
export const WorkOrderSelectOptions = {
  ...
  customerTypes: [
    ...
    { key: "Tract Builder", label: "Tract Builder" },
    { key: "unAllocated", label: "Unallocated" },
  ],
...
export const FEATURE_CODES = {
  ...
  "om.prod.wo.itemFacility": "om.prod.wo.itemFacility",
...
export const SOURCE_OF_UI = {
  modal_production: "modal_production",
  iframe_forms_approval: "iframe_forms_approval",
};
...
export const FACILITY_FROM_CODE = {
  1: "Langley",
  2: "Calgary",
};

export const FACILITY_CODE_FROM_NAME = {
  langley: "1",
  lalgary: "2",
};

export const ALL_SUBORDER_TYPES = [
  {
    suborder_code: "w_1",
    facility: "Langley",
  },
...
export const getStatusFieldByKind = (kind = "m") => {
  switch (kind) {
    case "w":
      return "m_WinStatus";
    case "d":
...
const DEV_HOLDING_FEATURES = {
  ...
  v20250113_multipoint: false, //process.env.NEXT_PUBLIC_ENV === "production",
  v20260330_bulkupdate: process.env.NEXT_PUBLIC_ENV === "production",
};
