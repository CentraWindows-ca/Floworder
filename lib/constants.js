...
export const ORDER_STATUS = [
  ...
  {
    label: "Draft",
    key: "Draft Work Order",
    color: "#DDA0DD",
    textColor: "#FFFFFF",
    icon: <i className="fa-solid fa-pen-to-square" style={{ color: "#DDA0DD" }} />,
  },
  {
    ...
    color: "#AAA05D",
    textColor: "#FFFFFF",
    icon: <i className="fa-solid fa-file-circle-check" style={{ color: "#AAA05D" }} />,
  },
  {
    ...
    color: "#DDA0D3",
    textColor: "#FFFFFF",
    icon: <i className="fa-solid fa-calendar-check" style={{ color: "#DDA0D3" }} />,
  },
  {
    ...
    color: "#DDA0BD",
    textColor: "#FFFFFF",
    icon: <i className="fa-solid fa-circle-check" style={{ color: "#DDA0BD" }} />,
  },
  {
    label: "Scheduled",
    ...
    color: "#9FB6CD",
    textColor: "#FFFFFF",
    icon: <i className="fa-solid fa-clock" style={{ color: "#9FB6CD" }} />,
  },
  {
    label: "In Progress",
    key: "In-Progress",
    color: "#A5D6A7",
    textColor: "#FFFFFF",
    icon: <i className="fa-solid fa-spinner" style={{ color: "#A5D6A7" }} />,
  },
  {
    label: "Ready to Ship",
    key: "Ready To Ship",
    color: "#FFFACD",
    textColor: "#64748B",
    icon: <i className="fa-solid fa-box-open" style={{ color: "#FFFACD" }} />,
  },
  {
    label: "Shipped",
    key: "Shipped",
    color: "#FFC966",
    textColor: "#FFFFFF",
    icon: <i className="fa-solid fa-truck" style={{ color: "#FFC966" }} />,
  },
  {
    label: "On Hold",
    key: "On Hold",
    color: "#FF6347",
    textColor: "#FFFFFF",
    icon: <i className="fa-solid fa-pause-circle" style={{ color: "#FF6347" }} />,
  },
];
