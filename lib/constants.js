...
export const ORDER_STATUS = [
  ...
  },
  {
    ...
    key: "Draft Reservation", 
    color: "#DDA0DD",
    textColor: "#FFFFFF",
  },
  {
    label: "Confirmed Reservation",
    key: "Confirmed Reservation",
    color: "#DDA0DD",
    textColor: "#FFFFFF",
  },
  {
    label: "Completed Reservation",
    key: "Completed Reservation",
    color: "#DDA0DD",
    textColor: "#FFFFFF",
  },
...
//   // include empty is master
//   "MASTER.branchId": { include: [] },
//   "WINDOW.blockNo": { include: [] },
//   "DOOR.blockNo": { include: [] },
//   "WINDOW.batchNo": { include: [] },
//   "DOOR.batchNo": { include: [] },
//   "MASTER.manufacturingFacility": { include: [] },
//   "MASTER.shippingType": { include: [] },
//   "MASTER.glassSupplier": { include: [] },
//   "MASTER.glassOption": { include: [] },
//   "MASTER.residentialType": { include: [] },
//   "MASTER.jobType": { include: [] },

//   "MASTER.customerType": { include: [] },
//   "MASTER.project": { include: [] },
//   "MASTER.salesReps" : { include: [] },
