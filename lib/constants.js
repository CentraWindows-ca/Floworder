...
export const ORDER_STATUS = [
  ...
  },
  {
    ...
    textColor: "#FFFFFF",
    icon: (
      <i className="fa-solid fa-pen-to-square" style={{ color: "#DDA0DD" }} />
    ),
  },
  {
  ...
  },
  {
    ...
    textColor: "#FFFFFF",
    icon: (
      <i className="fa-solid fa-calendar-check" style={{ color: "#DDA0D3" }} />
    ),
  },
  {
    ...
    textColor: "#FFFFFF",
    icon: (
      <i className="fa-solid fa-circle-check" style={{ color: "#DDA0BD" }} />
    ),
  },
  {
    label: "Scheduled",
  ...
  },
  {
    ...
    textColor: "#FFFFFF",
    icon: (
      <i className="fa-solid fa-pause-circle" style={{ color: "#FF6347" }} />
    ),
  },
];
