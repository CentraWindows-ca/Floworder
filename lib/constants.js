...
export const FEATURE_CODES = {
  "nav.prod.woView": "nav.prod.woView",
  "nav.prod.woEdit": "nav.prod.woEdit ",
  "nav.prod.woDelete": "nav.prod.woDelete",
  "nav.prod.woHistory": "nav.prod.woViewHistory",
  "nav.prod.statusSwitchGeneral": "nav.prod.statusSwitchGeneral",
};
