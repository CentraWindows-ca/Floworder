...
export default {
  ...
  getWorkOrder: async (initWorkOrderNo, isActive) => {
    return (
  ...
  getWorkOrderHistory: async (initWorkOrderNo) => {
    return (
      OrdersApi.queryWorkOrderHistoryAsync({
        workOrderNo: initWorkOrderNo,
      }) || {}
    );
  },

  updateWindowItem: async (m_MasterId, Id, fields, ref) => {
    if (_.isEmpty(fields)) {
      return {};
    }
  ...
  updateDoorItem: async (m_MasterId, Id, fields, ref) => {
    if (_.isEmpty(fields)) {
      return {};
    }
  ...
  updateItemList:  async (m_MasterId, updates, kind, ref) => {
