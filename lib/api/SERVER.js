...
let NEXT_API_SERVER = "http://localhost:1740";
...
let INVOICE_API = "https://staging-invoicesapi.centra.ca";
let DRAGONFLY_API = "https://QA-dragonfly-Api.centra.ca";
...
if (process.env.NEXT_PUBLIC_ENV === "production") {
  ...
  INVOICE_API = "https://invoicesapi.centra.ca";
  DRAGONFLY_API = "https://dragonflyapi.centra.ca";
}
...
const getHeaders = (tokenKey) => {
  if (typeof window !== "undefined") {
    ...
    return {
      ...
      ["centra-app-name"]: getCookie("APP_NAME"),
    };
  }
};
