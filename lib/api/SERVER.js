...
let SERVER = "https://localhost:7149";
let NEXT_API_SERVER = "http://localhost:1520";
...
if (process.env.NEXT_PUBLIC_ENV === "production") {
  ...
  PORTAL_WEBCAL = "https://webcalendar.centra.ca"
}
