...
const uploadFileAsync = async (params, body, ref) => {
  ...
  // sync back to history -- we want to skip this
...
const sync_AB_WindowMakerByWorkOrderAsync = async (params, body, ref) => {
  ...
  // sync back to FF
  await Prod2FFApi.sync_AB_Order_FF_Async(ref);
...
const sync_BC_WindowMakerByWorkOrderAsync = async (params, body, ref) => {
  ...
  // sync back to FF
  await Prod2FFApi.sync_BC_Order_FF_Async(ref);
...
const batchUpdateTableAsync = async (params, body, ref) => {
...
const updateWorkOrderHeaderWithPrefixAsync = async (
  ...
  // sync back to FF
  await Prod2FFApi.updateHeaderData2FFAsync(ref, parsedObj);
