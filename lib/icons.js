...
export const DoorPaintIcon = (props) => {
  const { style, className } = props;
  return (
    <div
      className={`inline-block ${className}`}
...
export const DoorMultipointIcon = (props) => {
  const { style, className } = props;
  return (
    <div
      className={`inline-block ${className}`}
    ...
    >
      <img
        src="/multi-point-icon.png"
        alt="Multi Point Icon"
        width={300} // Properties for resolution, not size
        height={300}
        style={{ width: style?.width || "16px", height: "auto" }}
      />
...
export const SlidingWindowIcon = (props) => {
  const { style, className } = props;
  return (
    <div
      className={`inline-block ${className}`}
...
export const CasementWindowIcon = (props) => {
  const { style, className } = props;
  return (
    <div
      className={`inline-block ${className}`}
    ...
    >
      <img
        src="/awning-window.png"
        alt="Casement Windows Icon"
        width={300} // Properties for resolution, not size
        height={250}
        style={{
          width: style?.width || "14px",
...
export const PatioAndSwingDoorIcon = (props) => {
  const { style, className } = props;
  return (
    <div
      className={`inline-block ${className}`}
    ...
    >
      <img
        src="/patio-door-bw.png"
        alt="Patio and Swing Door Icon"
        width={300} // Properties for resolution, not size
        height={300}
        style={{
          width: style?.width || "15px",
...
export const WaterTestingIcon = (props) => {
  const { style, className } = props;
  return (
    <div
      className={`inline-block ${className}`}
...
export const CartShippedIcon = (props) => {
  const { style, className } = props;
  return (
    <div
      className={`inline-block ${className}`}
    ...
    >
      <img
        src="/order-placed-purchased-icon.png"
        alt=""
        width={300} // Properties for resolution, not size
        height={300}
        style={{
...
export const MakeDealIcon = (props) => {
    const { style, className } = props;
    return (
        <div
            className={`inline-block ${className}`}
